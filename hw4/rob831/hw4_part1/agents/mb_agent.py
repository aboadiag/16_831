...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            i_samp = np.random.choice(num_data, num_data_per_ens, replace = False)
            observations = ob_no[i_samp]# TODO(Q1)
            actions = ac_na[i_samp]# TODO(Q1)
            next_observations = next_ob_no[i_samp]# TODO(Q1)
    ...
    def add_to_replay_buffer(self, paths, add_sl_noise=False):
        ...
        # print('data stats for debug', self.data_statistics)
